import{_ as s}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as e,e as i,a as n,b as t,f as c}from"./app.83d5c408.js";const l={},p=n("h1",{id:"git-常用命令清单",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#git-常用命令清单","aria-hidden":"true"},"#"),t(" Git 常用命令清单")],-1),o=n("p",null,"我每天使用 Git ，但是很多命令记不住。",-1),u=n("p",null,"一般来说，日常使用只要记住下图6个命令，就可以了。但是熟练使用，恐怕要记住60～100个命令。",-1),d=c(`<p><img src="https://www.ruanyifeng.com/blogimg/asset/2015/bg2015120901.png" alt="img" loading="lazy"></p><p>下面是我整理的常用 Git 命令清单。几个专用名词的译名如下。</p><blockquote><ul><li>Workspace：工作区</li><li>Index / Stage：暂存区</li><li>Repository：仓库区（或本地仓库）</li><li>Remote：远程仓库</li></ul></blockquote><h2 id="一、新建代码库" tabindex="-1"><a class="header-anchor" href="#一、新建代码库" aria-hidden="true">#</a> 一、新建代码库</h2><blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 在当前目录新建一个Git代码库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><p>（完）</p>`,25);function m(r,v){return a(),e("div",null,[p,o,u,i(" more "),d])}const g=s(l,[["render",m],["__file","reprint-common.html.vue"]]);export{g as default};
